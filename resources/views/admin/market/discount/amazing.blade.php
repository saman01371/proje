                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach ($amazingSales as $amazingSale)
                            <tr>
                                ...
                                <td>{{ \Morilog\Jalali\Jalalian::forge($amazingSale->start_date)->format('%A, %d %B %Y H:i:s') }}</td>
                                <td>{{ \Morilog\Jalali\Jalalian::forge($amazingSale->end_date)->format('%A, %d %B %Y H:i:s') }}</td>
