                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach ($commonDiscounts as $commonDiscount)
                            ...
                            <tr>
                                ...
                                <td>{{ \Morilog\Jalali\Jalalian::forge($commonDiscount->start_date)->format('%A, %d %B %Y H:i:s') }}</td>
                                <td>{{ \Morilog\Jalali\Jalalian::forge($commonDiscount->end_date)->format('%A, %d %B %Y H:i:s') }}</td>
