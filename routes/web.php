...
Route::prefix('admin')->middleware('auth')->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->namespace('Market')->group(function () {
        ...
        Route::prefix('delivery')->group(function () {
            ...
            Route::get('/show', [DeliveryController::class, 'create'])->name('admin.market.delivery.create');
    ...
    Route::prefix('content')->namespace('Content')->group(function () {
        ...
        //category
        //  Route::prefix('category')->middleware(RoleMiddlware::class.':operator')->group(function () {
...
//post
    ...
    Route::prefix('setting')->namespace('Setting')->group(function () {
        ...
        Route::get('/status/{setting}', [SettingController::class, 'status'])->name('admin.notify.setting.status');
...
Route::namespace('Auth')->group(function () {
    ...
    Route::post('/login-register', [LoginRegisterController::class, 'loginRegister'])->name('auth.customer.login-register')->middleware(['throttle:6,1']);
    Route::get('login-confirm/{token}/{otpCode}', [LoginRegisterController::class, 'loginConfirmForm'])->name('auth.customer.login-confirm-form');
    Route::post('/login-confirm/{token}/{otpCode}', [LoginRegisterController::class, 'loginConfirm'])->name('auth.customer.login-confirm')->middleware(['throttle:2,1']);
    Route::get('/login-resend-otp/{token}/{otpCode}', [LoginRegisterController::class, 'loginResendOtp'])->name('auth.customer.login-resend-otp');
